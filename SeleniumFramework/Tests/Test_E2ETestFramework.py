...
# pytest -n 2 -m smoke --browser_name chrome --html=reports/report.html
...
# test_list will have all lists of data from json and it will give one by one record for execution to test_list_item
