...
from apitesting.utilities.configurations import getConfig, getPassword
...
def step_impl(context):
    ...
    context.payLoad = addBookPayload("test1", "9001");
...
def step_impl(context):
    ...
    context.se.auth = auth = ('subbaraom', getPassword())
